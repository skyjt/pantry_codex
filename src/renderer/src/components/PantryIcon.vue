...
<template>
  ...
  >
    ...
    <g v-else-if="name === 'settings'">
      <path d="M10.2 4.4h3.6l.5 2.1c.5.2.9.4 1.3.8l2-.7 1.8 3.1-1.5 1.5a6.7 6.7 0 0 1 0 1.6l1.5 1.5-1.8 3.1-2-.7c-.4.3-.8.6-1.3.8l-.5 2.1h-3.6l-.5-2.1c-.5-.2-.9-.4-1.3-.8l-2 .7-1.8-3.1 1.5-1.5a6.7 6.7 0 0 1 0-1.6L4.6 9.7l1.8-3.1 2 .7c.4-.3.8-.6 1.3-.8l.5-2.1Z" />
    ...
    <g v-else-if="name === 'pk'">
      <path d="m4.9 13.2 3.2-3.2a2 2 0 0 1 2.8 0l1.7 1.7-4.9 4.9-2.8-2.8c-.2-.2-.2-.4 0-.6Z" />
      <path d="m19.1 13.2-3.2-3.2a2 2 0 0 0-2.8 0l-1.7 1.7 4.9 4.9 2.8-2.8c.2-.2.2-.4 0-.6Z" />
      <path d="m7.2 8.2-1.1-1.1" />
      <path d="m16.8 8.2 1.1-1.1" />
      <path d="M10 14h4" />
    </g>
    <g v-else-if="name === 'pk-rps'">
      <path d="M8.2 18V8.7a1.4 1.4 0 0 1 2.8 0v4.8" />
      <path d="M11 13.5V6.5a1.4 1.4 0 0 1 2.8 0v7" />
      <path d="M13.8 13.7V9.4a1.4 1.4 0 0 1 2.8 0v6.4" />
      <path d="m8.2 14.8-1.4-1.2a1.4 1.4 0 0 0-1.9 2.1l3 3.1c.8.8 1.9 1.2 3 1.2h1.8a3.9 3.9 0 0 0 3.9-3.9v-.5" />
    </g>
    <g v-else-if="name === 'pk-dice'">
      <rect x="6.2" y="6.2" width="11.6" height="11.6" rx="2.4" />
      <path d="M9.4 9.4h.1" />
      <path d="M14.5 9.4h.1" />
      <path d="M12 12h.1" />
      <path d="M9.4 14.6h.1" />
      <path d="M14.5 14.6h.1" />
    </g>
