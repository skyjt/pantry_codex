...
**v0.1、v0.2、v0.3、v0.4/P1 主链路已完成，本地迭代至 v0.29.3**（对照 tech-design §12）。Windows / Debian / UOS 真实打包运行测试留给目标平台执行：
