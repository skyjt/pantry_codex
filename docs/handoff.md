...
> 最后更新：2026-06-12（v0.5.18 沉浸式跨平台修正，决议 #51/#52：mac 红绿灯移列表栏顶部；Linux 弃 CSS 拖拽区改 JS 拖拽，修 UOS 点击失效）。**本文描述"当前状态与下一步"，会过期——以 `git log` 与各文档变更记录为准。**
