...
| | |
|---|---|
| 状态 | v0.27，P1 本地交付候选；输入框 emoji 兼容已补齐，目标平台真实打包/运行冒烟待 Windows / Debian / UOS 执行 |
| 日期 | 2026-06-12 |
